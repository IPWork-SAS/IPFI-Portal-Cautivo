...
<style>
    ...
    body::before {
        ...
        left: 0;
        /* IE Fallback */
        background-color:  <?=$styles->color_background?>!important;
        width: 100%;
        height: 100%;
    }
    .title {
    ...
    .screen .filter {
        background: <?=$styles->container_form_color?>!important;
        color: <?=$styles->container_form_font_color?>!important;
        opacity:1!important;
    }
    ...
    .screen .button-container button {
        color: <?=$styles->button_font_color?>!important;
        background-color: <?=$styles->button_background_color?>!important;
        border-color: <?=$styles->button_border_color?>!important;
        padding: 10px;
        margin-bottom: 10%;
        width: 50%;  
        border-radius: 500px;
            ...
            <div class="col-sm-12 my-auto">
                <div class="card"> 
                    <div class="screen">
                        ...
                        <p class="desc title"><?=$styles->title_portal ? $styles->title_portal : $lang['titulo_form'];?></p>
